...
Videos appear under Qualitative Results, grouped by scenario, with a scenario selector when multiple scenarios are present. Native playback, seeking, volume, and fullscreen controls are available. Videos are muted initially and do not autoplay. Playing one pauses other videos. A direct Open video link is provided for each clip.
